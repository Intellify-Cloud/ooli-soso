...
description: Estimate the bond and transfer costs involved in buying a home with the oobalink Northern Suburbs transfer cost calculator.
background: white
full_width: true
permalink: /transfer-cost-calculator/
---

{% assign calculator = site.data.sitetext.calculator_pages.transfer %}
...
<section class="calculator-detail page-section" id="{{ calculator.anchor }}">
  <div class="container">
    <iframe class="calc calc--transfer" frameborder="0"
